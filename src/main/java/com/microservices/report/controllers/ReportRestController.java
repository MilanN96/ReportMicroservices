...
public class ReportRestController {
    ...
    @GetMapping("/studentsForDepartman/{departmanId}")
    public ArrayList<Object> getstudentsForDepartman(@PathVariable("departmanId") Integer id) {
        return feignRepository.getStudentsForDepartmanPdf(id);
    }
    ...
    @GetMapping("/studentsForDepartmanPdf/{departmanId}")
    public void getStudentsForDepartmanPdf(@PathVariable("departmanId") Integer id, HttpServletResponse response) {
        try {

        /*    ArrayList<Object> students = feignRepository.getStudentsForDepartmanPdf(id);
            Departman departman = feignRepository.getOneDepartman(id);

            Resource resource = appContext.getResource("classpath:/reports/studentsForDepartman.jrxml");
